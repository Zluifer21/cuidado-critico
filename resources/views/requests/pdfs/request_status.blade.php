...
<body>
    <table>
        <tbody style="height: 10px;">
            <tr>
                <td rowspan="4" style="width: 20%; border: 1px solid #000;"><img src="{{ public_path('img/uci.jpg') }}" style="max-width: 100%; max-height: 100%;">
                </td>
    ...
    <table style="height: 47px; width: 100%;">
        <tbody>
            ...
            <tr style="width: 100%;">
                ...
                <td colspan="3" style="width: 79%; border: 1px solid #000;">{{ $requests['employee']['first_name'] }} {{ $requests['employee']['last_name'] }}</td>
                <td style="width: 1%;"></td>
            </tr>
            ...
            <tr style="width: 100%;">
                ...
                <td style="width: 30%; border: 1px solid #000;">{{ $requests['employee']['title'] }}</td>
                <td style="width: 20%; text-align: center;">AREA</td>
                <td style="width: 29%; border: 1px solid #000;">{{ strtoupper($requests['employee']['department'][0]['name']) }}</td>
                <td style="width: 1%;"></td>
            </tr>
            ...
            <tr style="width: 100%;">
                ...
                <td colspan="3" style="width: 79%; border: 1px solid #000;">{{ $requests['employee']['manager']['first_name'] }} {{ $requests['employee']['manager']['last_name'] }}</td>
                <td style="width: 1%;"></td>
            </tr>
    ...
    <table style="width: 100%;">
        <tbody>
            ...
            <tr>
                <td style="width: 21%;">&nbsp;</td>
                <td style="width: 5%;">&nbsp;</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">{{ date('d', strtotime($requests['created_at'])) }}</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">{{ date('m', strtotime($requests['created_at'])) }}</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">{{ date('Y', strtotime($requests['created_at'])) }}</td>
                <td style="width: 5%;">&nbsp;</td>
                <td style="width: 21%;">&nbsp;</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">{{ date('d', strtotime($requests['date'])) }}</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">{{ date('m', strtotime($requests['date'])) }}</td>
                <td style="width: 7%; border: 1px solid #000;  text-align: center;">{{ date('Y', strtotime($requests['date'])) }}</td>
                <td style="width: 1%;"></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 5%;">&nbsp;</td>
                <td colspan="3" style="width: 24%; border: 1px solid #000;  text-align: center;">{{ date('g:i A', strtotime($requests['time'])) }}</td>
                <td style="width: 5%;">&nbsp;</td>
                <td style="width: 21%;">DURACION PERMISO</td>
                <td colspan="3" style="width: 23%; border: 1px solid #000;  text-align: center;">{{ $requests['long'] }} {{ $requests['long'] == 1 ? 'hora' : 'horas' }}</td>
                <td style="width: 1%;"></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 5%;">&nbsp;</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">@if ($requests['type']['id'] == 1)
                    X
                    @endif
                </td>
                <td style="width: 8%;">&nbsp;</td>
                ...
                <td style="width: 8%;  text-align: center;">@if ($requests['type']['id'] == 2)
                    X
                    @endif
                </td>
                <td style="width: 7%;">&nbsp;</td>
            ...
            <tr>
                ...
                <td style="width: 5%;">&nbsp;</td>
                <td style="width: 8%; border: 1px solid #000;  text-align: center;">@if ($requests['type']['id'] == 3)
                    X
                    @endif
                </td>
                <td style="width: 8%;">&nbsp;</td>
                ...
                <td style="width: 8%; border: 1px solid #000;">&nbsp;</td>
                <td style="width: 8%;  text-align: center;">@if ($requests['type']['id'] == 4)
                    X
                    @endif</td>
                <td style="width: 7%;">&nbsp;</td>
                <td style="width: 1%;"></td>
            ...
            <tr>
                ...
                <td style="width: 5%;">&nbsp;</td>
                <td style="width: 8%; border: 1px solid #000; text-align: center;">@if ($requests['type']['id'] == 5)
                    X @endif</td>
                <td style="width: 8%;">&nbsp;</td>
                <td style="width: 8%;">&nbsp;</td>
                <td style="width: 5%;">&nbsp;</td>
                ...
                <td style="width: 8%; border: 1px solid #000;">&nbsp;</td>
                <td style="width: 8%;  text-align: center;">@if ($requests['type']['id'] == 6)
                    X
                    @endif</td>
                <td style="width: 7%;">&nbsp;</td>
                <td style="width: 1%;"></td>
    ...
    <table style="width: 100%;">
        <tbody>
            <tr>
                <td style="height: 97px; width: 100%; border: 1px solid #000;">&nbsp;</td>
            </tr>
        </tbody>
    </table>
    <table style="height: 97px; border: 1px solid #000;" width="100%">
        <tbody>
            <tr style="height: 66px;">
                <td style="width: 50%; height: 66px;text-align: center;"></td>
                <td style="width: 50%; height: 66px;text-align: center;"></td>
            </tr>
