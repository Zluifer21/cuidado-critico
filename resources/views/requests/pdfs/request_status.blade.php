...
<table style="height: 47px; width: 100%;">
    ...
    <tr style="width: 100%;">
        ...
        <td colspan="3" style="width: 79%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 1%;"></td>
    </tr>
    ...
    <tr style="width: 100%;">
        ...
        <td style="width: 29%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 1%;"></td>
    </tr>
...
<table style="width: 100%;">
    ...
    <tr>
        ...
        <td style="width: 8%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 8%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 7%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 1%;"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="width: 5%;">&nbsp;</td>
        <td colspan="3" style="width: 24%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 5%;">&nbsp;</td>
        <td style="width: 21%;">DURACION PERMISO</td>
        <td colspan="3" style="width: 23%; border: 1px solid #000;">&nbsp;</td>
        <td style="width: 1%;"></td>
    </tr>
